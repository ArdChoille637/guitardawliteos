...
**Status 2026-07-09: code written, host-tested, cross-compiles — hardware gate pending** (needs the Pi 5 + codecs on the bench). Source: [src/](../src/), host tests: [tests/](../tests/).
