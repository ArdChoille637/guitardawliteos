...
| 1 | SC1158 | 27 W USB-C PD supply (US, black) | 12 | **In use on the bench** — Pi 5 needs the 5 V/5 A mode. (SC1407 is the EU plug — avoid.) The target build replaces it with a 5 V buck off the 18 V pack (`docs/power-tree-18v.md`); keep this for bench work either way. |
